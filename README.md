...
- **L3 (this PR)** — **editor elevation**: detected entities shown as colour-coded **`EntityChip`s** (per-PII hue dot + label + count), spaced operator cards, a **monospace redacted preview** on a tonal surface with a **copy** action.
